...
# Neural Network with forward and backward pass
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        # Uncomment the following lines if you are not familiar with the lambda function
        #def sigmoid(x):
        #    return 1/(1+np.exp(-x))  # 
...
#         print('delta_o:', output_error_term.shape)
        
        hidden_error_term = hidden_error * hidden_outputs * (1 - hidden_outputs)
#         print('delta_h:', hidden_error_term.shape)
